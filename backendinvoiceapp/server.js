...
const allowedOrigins = [
  process.env.FRONTEND_URL || 'https://www.dbill.io/',  // URL Frontend de production ou de développement
  process.env.STAGING_FRONTEND_URL || 'https://staging.dbill.io'  // URL Frontend de staging
];
